...
/**	PathValidator<br>
 *  Private constructor and 4 static methods that verifies a file, directory, general path exists and is not a symbolic link. And
 *  a method the verifies a path is a symbolic link
 * */
